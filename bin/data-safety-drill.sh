...
TABLES=(pl_tax_profiles pl_sales_reports pl_sales_report_lines pl_purchase_summaries
        pl_settlements pl_report_versions pl_payment_obligations pl_audit_events)
...
step "7  Odtworzenie po nieudanym wyliczeniu"
